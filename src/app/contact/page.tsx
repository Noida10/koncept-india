            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-[#c6d1f0] text-[#2755c5] rounded-lg flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <a href="tel:+918860331991" className="text-gray-600 hover:text-[#2755c5]">
                      {siteInfo.phone}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${siteInfo.email}`} className="text-gray-600 hover:text-[#2755c5]">
                      {siteInfo.email}
                    </a>
                  </div>
                </div>
