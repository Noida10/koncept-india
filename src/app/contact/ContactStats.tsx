...
const stats = [
  { end: 15, suffix: "+", label: "Years of Experience", icon: "calendar" },
  { end: 500, suffix: "+", label: "Projects Delivered", icon: "folder" },
  { end: 100, suffix: "+", label: "Happy Clients", icon: "users" },
  { end: 6, suffix: "+", label: "Printing Technologies", icon: "cog" },
];
...
export default function ContactStats() {
  return (
    <section className="bg-[#2755c5] text-white py-12">
