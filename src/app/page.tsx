      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal className="text-center mb-12">
            ...
            <p className="text-gray-700 text-lg max-w-2xl mx-auto">{content.products.subtitle}</p>
          </ScrollReveal>
            ...
            {content.products.categories.map((cat, i) => (
              <ScrollReveal key={cat.id} delay={i * 100}>
                <Link
                  ...
                  className="group block bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg hover:border-amber-200 transition-all text-center"
                >
                  <div className="w-14 h-14 bg-amber-50 text-amber-700 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:bg-amber-700 group-hover:text-white transition-colors">
                    {i === 0 && (
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    ...
                    {cat.items.length > 4 && (
                      <li className="text-amber-700 font-medium">+ {cat.items.length - 4} more</li>
                    )}
                  </ul>
                </Link>
              </ScrollReveal>
      ...
      <section>
        <ScrollReveal>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-4">
            <h2 className="text-center text-xl font-semibold text-gray-700 uppercase tracking-wide">
